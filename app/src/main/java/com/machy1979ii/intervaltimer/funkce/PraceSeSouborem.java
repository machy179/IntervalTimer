...
public class PraceSeSouborem {
    ...
    public void writeToFile(String data) {
        ...
        File dir = new File(path + "/ClassicTimer");
        if (!dir.exists())
            dir.mkdirs();
    ...
    public void writeToFileInternal(String data, Context context) {
        ...
        File file = new File(context.getFilesDir() + "/ClassicTimer", "data.txt");

        //      String path = Environment.getExternalStorageDirectory().toString();
        //      String vysledekUlozeni;

        File dir = new File(context.getFilesDir() + "/ClassicTimer");
        if (!dir.exists())
            dir.mkdirs();
    ...
    public void writeToFileInternalZvuk(String data, Context context) {
        ...
        File file = new File(context.getFilesDir() + "/ClassicTimer", "datatime.txt");
    ...
    public void writeToFileInternalColor(String data, Context context) {
        Log.i("asdf:", "5");
        File file = new File(context.getFilesDir() + "/ClassicTimer", "datacolor.txt");
