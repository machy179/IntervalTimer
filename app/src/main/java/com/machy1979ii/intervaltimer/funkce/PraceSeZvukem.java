...
public class PraceSeZvukem {
    ...
    private static int pocetZvukuPulkaCviceni = 49;
    private static String[] nazvyZvukuPulkaCviceni = new String[49];
    ...
    public static int vratPocetZvukuPulkaCviceni() {
        return pocetZvukuPulkaCviceni;
    ...
    public static String[] vratNazvyZvukuPulkaCviceni(String nazevZvukuPolozka) {

        for (int i=0; i<(pocetZvukuPulkaCviceni); i++) {
            if (i<(pocetZvukuPulkaCviceni-1))  {
                nazvyZvukuPulkaCviceni[i] = nazevZvukuPolozka+ " " +String.valueOf(i+1);

            } else {
            //    nazvyZvukuPulkaCviceni[i] = getResources().getString(R.string.NoSound);
                nazvyZvukuPulkaCviceni[i] = "X";
            }

        }

        return nazvyZvukuPulkaCviceni;
        //    return nazvyZvukuStartStop;
