...
public class SetSoundCustomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cisloNastavenehoZvukuKonec = getIntent().getIntExtra("zvukcelkovykoneccustom", 1);
        cisloNastavenehoZvukuCountdown = getIntent().getIntExtra("zvukcountdowncustom", 1);

        cisloNastavehoZvukuRestTabatas = getIntent().getIntExtra("zvukresttabatassetsound", 1);
        hlasitost = getIntent().getIntExtra("hlasitostcustom",hlasitost);
    ...
    private void udelejLayout() {
        setContentView(R.layout.activity_set_sound_custom);
...
//        Toast.makeText(this, "onConfigurationChanged", Toast.LENGTH_SHORT).show();
    ...
    public void zmacknutyOk(View v) {
        ...
        mainActivity.putExtra("zvukcelkovykoneccustom",cisloNastavenehoZvukuKonec);

        mainActivity.putExtra("zvukcountdowncustom",cisloNastavenehoZvukuCountdown);

        mainActivity.putExtra("hlasitostcustom",hlasitost);
